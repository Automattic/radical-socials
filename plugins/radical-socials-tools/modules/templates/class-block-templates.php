...
function radical_socials_block_template_registry(): array {
	return [
		'archive-rs_feed_item' => [
			'title'       => __( 'Feed Archive', 'radical-socials-tools' ),
			'description' => __( 'Default layout for the Feed archive when the active theme does not provide one.', 'radical-socials-tools' ),
		],
		'archive-rs_favorite' => [
			'title'       => __( 'Favorites Archive', 'radical-socials-tools' ),
			'description' => __( 'Default layout for the Favorites archive when the active theme does not provide one.', 'radical-socials-tools' ),
		],
	];
}
