...
?>
<div
	class="rs-like-button-wrap wp-block-heckl-like-button"
...
>
	...
	>
		<span aria-hidden="true" class="rs-like-icon-filled" data-wp-bind--hidden="!context.favorited"<?php echo $heckl_favorited ? '' : ' hidden'; ?>>♥</span>
		<span aria-hidden="true" class="rs-like-icon-empty"  data-wp-bind--hidden="context.favorited"<?php echo $heckl_favorited ? ' hidden' : ''; ?>>♡</span>
	</button>
</div>
