 ...
 * Slug: heckl/hidden-search-results
 * Inserter: no
 */
?>
...
<main class="wp-block-group">
	...
	<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
		...
		<!-- wp:search {"label":"<?php echo esc_attr__( 'Search', 'heckl' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Search…', 'placeholder text', 'heckl' ); ?>","buttonText":"<?php echo esc_attr__( 'Search', 'heckl' ); ?>"} /-->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-query">
		<!-- wp:post-template -->
			<!-- wp:pattern {"slug":"heckl/loop-content"} /-->
		<!-- /wp:post-template -->
		...
		<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
			<!-- wp:query-no-results -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'No results found. Try a different search?', 'heckl' ); ?></p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:group -->
