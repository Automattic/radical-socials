...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<h1 class="wp-block-heading has-text-align-center"><?php echo esc_html__( '404', 'radical-socials' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center"} -->
	<p class="has-text-align-center"><?php echo esc_html__( 'The page you\'re looking for doesn\'t exist.', 'radical-socials' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:search {"label":"<?php echo esc_attr__( 'Search', 'radical-socials' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Search…', 'placeholder text', 'radical-socials' ); ?>","buttonText":"<?php echo esc_attr__( 'Search', 'radical-socials' ); ?>","align":"center"} /-->
