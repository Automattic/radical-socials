...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-activitypub-reactions alignfull is-style-facepile">
		...
		<h3 class="wp-block-heading has-small-font-size"><?php echo esc_html__( 'Fediverse reactions', 'radical-theme' ); ?></h3>
		<!-- /wp:heading -->
	</div>
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	<!-- wp:post-terms {"term":"post_tag","separator":"  ","prefix":"<?php echo esc_attr__( 'Tags: ', 'radical-theme' ); ?>","className":"is-style-post-terms-1"} /-->
</div>
<!-- /wp:group -->
